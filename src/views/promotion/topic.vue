  ...
  <div class="app-container">
    ...
    <div class="filter-container">
      <el-input
        ...
        class="filter-item"
        style="width: 200px"
        :placeholder="$t('promotion_topic.placeholder.filter_title')"
      />
      <el-input
        ...
        class="filter-item"
        style="width: 200px"
        :placeholder="$t('promotion_topic.placeholder.filter_subtitle')"
      />
      <el-select
        v-model="listQuery.sort"
        class="filter-item"
        :placeholder="$t('promotion_topic.placeholder.filter_sort')"
      >
        <el-option
    ...
    >
      ...
      <el-table-column
        align="center"
        :label="$t('promotion_topic.table.title')"
        prop="title"
      />

      <el-table-column
        align="center"
        :label="$t('promotion_topic.table.subtitle')"
        min-width="200"
        prop="subtitle"
      />
      ...
      <el-table-column
        align="center"
        property="picUrl"
        :label="$t('promotion_topic.table.pic_url')"
      >
      ...
      <el-table-column
        align="center"
        :label="$t('promotion_topic.table.content')"
        prop="content"
      >
        <template slot-scope="scope">
          <el-dialog
            :visible.sync="contentDialogVisible"
            :title="$t('promotion_topic.dialog.content_detail')"
          >
          ...
          >{{ $t("app.button.view") }}</el-button>
        </template>
      </el-table-column>

      <el-table-column
        align="center"
        :label="$t('promotion_topic.table.price')"
        prop="price"
      />

      <el-table-column
        align="center"
        :label="$t('promotion_topic.table.read_count')"
        prop="readCount"
      />

      <el-table-column
        align="center"
        :label="$t('promotion_topic.table.actions')"
        min-width="100"
