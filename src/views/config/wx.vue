    ...
    <el-form ref="dataForm" :rules="rules" :model="dataForm" status-icon label-width="300px">
      <el-tabs tab-position="left">
        <el-tab-pane :label="$t('config_wx.section.home')">
          <el-form-item :label="$t('config_wx.form.index_new')" prop="store_wx_index_new">
            <el-input v-model="dataForm.store_wx_index_new" />
          </el-form-item>
          <el-form-item :label="$t('config_wx.form.index_hot')" prop="store_wx_index_hot">
            <el-input v-model="dataForm.store_wx_index_hot" />
          </el-form-item>
          <el-form-item :label="$t('config_wx.form.index_brand')" prop="store_wx_index_brand">
            <el-input v-model="dataForm.store_wx_index_brand" />
          </el-form-item>
          <el-form-item :label="$t('config_wx.form.index_topic')" prop="store_wx_index_topic">
            <el-input v-model="dataForm.store_wx_index_topic" />
          </el-form-item>
          <el-form-item :label="$t('config_wx.form.catlog_list')" prop="store_wx_catlog_list">
            <el-input v-model="dataForm.store_wx_catlog_list" />
          </el-form-item>
          <el-form-item :label="$t('config_wx.form.catlog_goods')" prop="store_wx_catlog_goods">
            <el-input v-model="dataForm.store_wx_catlog_goods" />
          </el-form-item>
        </el-tab-pane>
        <el-tab-pane :label="$t('config_wx.section.other')">
          <el-form-item :label="$t('config_wx.form.share')" prop="store_wx_share">
