  ...
  <div class="app-container">
    ...
    <div class="filter-container">
      <el-input
        ...
        class="filter-item"
        style="width: 200px"
        :placeholder="$t('mall_aftersale.placeholder.filter_aftersale_sn')"
      />
      <el-input
        ...
        class="filter-item"
        style="width: 200px"
        :placeholder="$t('mall_aftersale.placeholder.filter_order_id')"
      />
      <el-button
    ...
    <div class="operator-container">
      ...
      >{{ $t("mall_aftersale.button.batch_recept") }}</el-button>
      <el-button
      ...
      >{{ $t("mall_aftersale.button.batch_reject") }}</el-button>
    </div>

    <el-tabs v-model="tab" @tab-click="handleClick">
      <el-tab-pane :label="$t('mall_aftersale.section.all')" name="all" />
      <el-tab-pane
        :label="$t('mall_aftersale.section.uncheck')"
        name="uncheck"
      />
      <el-tab-pane
        :label="$t('mall_aftersale.section.unrefund')"
        name="unrefund"
      />
    </el-tabs>
    ...
    >
      ...
      <el-table-column
        align="center"
        :label="$t('mall_aftersale.table.aftersale_sn')"
        prop="aftersaleSn"
      />
      <el-table-column
        align="center"
        :label="$t('mall_aftersale.table.order_id')"
        prop="orderId"
      />
      <el-table-column
        align="center"
        :label="$t('mall_aftersale.table.user_id')"
        prop="userId"
      />
      <el-table-column
        align="center"
        :label="$t('mall_aftersale.table.type')"
        prop="type"
      >
      ...
      <el-table-column
        align="center"
        :label="$t('mall_aftersale.table.reason')"
        prop="reason"
      />
      <el-table-column
        align="center"
        :label="$t('mall_aftersale.table.amount')"
        prop="amount"
      />
      <el-table-column
        align="center"
        :label="$t('mall_aftersale.table.add_time')"
        prop="addTime"
      />

      <el-table-column
        align="center"
        :label="$t('mall_aftersale.table.actions')"
        min-width="120"
      ...
      >
        <template slot-scope="scope">
          ...
          >{{ $t("mall_aftersale.button.recept") }}</el-button>
          <el-button
            v-if="scope.row.status === 1"
          ...
          >{{ $t("mall_aftersale.button.reject") }}</el-button>
          <el-button
          ...
          >{{ $t("mall_aftersale.button.refund") }}</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog
      ...
      :title="$t('mall_aftersale.dialog.detail')"
      width="800"
    >
      <section ref="print">
        <el-form :data="aftersaleDetail" label-position="left">
          ...
          <el-form-item :label="$t('mall_aftersale.form.status')">
            <el-tag v-if="aftersaleDetail.status === 1">{{
              $t("mall_aftersale.value.status_1")
            }}</el-tag>
            <el-tag v-if="aftersaleDetail.status === 2">{{
              $t("mall_aftersale.value.status_2")
            }}</el-tag>
            <el-tag v-if="aftersaleDetail.status === 3">{{
              $t("mall_aftersale.value.status_3")
            }}</el-tag>
            <el-tag v-if="aftersaleDetail.status === 4">{{
              $t("mall_aftersale.value.status_4")
            }}</el-tag>
          </el-form-item>
          ...
          <el-form-item :label="$t('mall_aftersale.form.type')">
            <el-tag v-if="aftersaleDetail.type === 0">{{
              $t("mall_aftersale.value.type_0")
            }}</el-tag>
            <el-tag v-if="aftersaleDetail.type === 1">{{
              $t("mall_aftersale.value.type_1")
            }}</el-tag>
            <el-tag v-if="aftersaleDetail.type === 2">{{
              $t("mall_aftersale.value.type_2")
            }}</el-tag>
          </el-form-item>
          ...
          <el-form-item :label="$t('mall_aftersale.form.pictures')">
            ...
            >
              <el-table-column
                align="center"
                :label="$t('mall_aftersale.table.detail_pictures')"
              >
                <template slot-scope="scope">
      ...
      <span slot="footer" class="dialog-footer">
        <el-button @click="aftersaleDialogVisible = false">{{
          $t("mall_aftersale.button.cancel")
        }}</el-button>
      </span>
    </el-dialog>
  </div>
