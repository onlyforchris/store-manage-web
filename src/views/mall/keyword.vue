  ...
  <div class="app-container">
    ...
    >
      ...
      <el-table-column
        align="center"
        min-width="100px"
        :label="$t('mall_keyword.table.keyword')"
        prop="keyword"
      />
      ...
      <el-table-column
        align="center"
        min-width="300px"
        :label="$t('mall_keyword.table.url')"
        prop="url"
      />
      ...
      <el-table-column
        align="center"
        min-width="100px"
        :label="$t('mall_keyword.table.is_hot')"
        prop="isHot"
      >
        <template slot-scope="scope">
          <el-tag :type="scope.row.isHot ? 'success' : 'error'">{{
            $t(
              scope.row.isHot ? "mall_keyword.text.yes" : "mall_keyword.text.no"
            )
          }}</el-tag>
        </template>
      </el-table-column>
      ...
      <el-table-column
        align="center"
        min-width="100px"
        :label="$t('mall_keyword.table.is_default')"
        prop="isDefault"
      >
        <template slot-scope="scope">
      ...
      <el-table-column
        align="center"
        :label="$t('mall_keyword.table.actions')"
        width="250"
      ...
      >
        ...
        <el-form-item :label="$t('mall_keyword.form.is_hot')" prop="isHot">
          <el-select
            ...
            :placeholder="$t('mall_keyword.form.is_hot.placeholder')"
          >
            <el-option
              :value="true"
              :label="$t('mall_keyword.value.is_hot_true')"
            />
            <el-option
              :value="false"
              :label="$t('mall_keyword.value.is_hot_false')"
            />
          </el-select>
        </el-form-item>
        <el-form-item
          :label="$t('mall_keyword.form.is_default')"
          prop="isDefault"
        >
          <el-select
            v-model="dataForm.isDefault"
            :placeholder="$t('mall_keyword.form.is_default.placeholder')"
          >
            <el-option
              :value="true"
              :label="$t('mall_keyword.value.is_default_true')"
            />
            <el-option
              :value="false"
              :label="$t('mall_keyword.value.is_default_false')"
            />
          </el-select>
        </el-form-item>
      </el-form>
