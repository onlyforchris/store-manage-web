<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column
        align="center"
        :label="$t('user_user.table.nickname')"
        prop="nickname"
      />

      <el-table-column
        align="center"
        :label="$t('user_user.table.avatar')"
        width="80"
      >
      ...
      <el-table-column
        align="center"
        :label="$t('user_user.table.mobile')"
        prop="mobile"
      />

      <el-table-column
        align="center"
        :label="$t('user_user.table.gender')"
        prop="gender"
      >
        <template slot-scope="scope">
      ...
      <el-table-column
        align="center"
        :label="$t('user_user.table.birthday')"
        prop="birthday"
      />

      <el-table-column
        align="center"
        :label="$t('user_user.table.user_level')"
        prop="userLevel"
      >
        <template slot-scope="scope">
      ...
      <el-table-column
        align="center"
        :label="$t('user_user.table.status')"
        prop="status"
      >
        <template slot-scope="scope">
    ...
    >
      ...
      >
        ...
        <el-form-item :label="$t('user_user.form.gender')" prop="gender">
          <el-select
            ...
            :placeholder="$t('user_user.placeholder.gender')"
          ><el-option
        ...
        <el-form-item :label="$t('user_user.form.user_level')" prop="userLevel">
          <el-select
            ...
            :placeholder="$t('user_user.placeholder.user_level')"
          ><el-option
        ...
        <el-form-item :label="$t('user_user.form.status')" prop="status">
          <el-select
            ...
            :placeholder="$t('user_user.placeholder.status')"
          ><el-option
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="handleUserUpdate">{{
