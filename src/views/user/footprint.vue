  ...
  <div class="app-container">
    ...
    <div class="filter-container">
      <el-input
        ...
        class="filter-item"
        style="width: 200px"
        :placeholder="$t('user_footprint.placeholder.filter_user_id')"
      />
      <el-input
        ...
        class="filter-item"
        style="width: 200px"
        :placeholder="$t('user_footprint.placeholder.filter_goods_id')"
      />
      <el-button
        class="filter-item"
        type="primary"
    ...
    >
      <el-table-column
        align="center"
        width="100px"
        :label="$t('user_footprint.table.id')"
        prop="id"
        sortable
      />
      ...
      <el-table-column
        align="center"
        min-width="100px"
        :label="$t('user_footprint.table.user_id')"
        prop="userId"
      />
      ...
      <el-table-column
        align="center"
        min-width="100px"
        :label="$t('user_footprint.table.goods_id')"
        prop="goodsId"
      />
      ...
      <el-table-column
        align="center"
        min-width="100px"
        :label="$t('user_footprint.table.add_time')"
        prop="addTime"
      />
    </el-table>
