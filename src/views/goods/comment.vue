  ...
  <div class="app-container">
    ...
    <div class="filter-container">
      <el-input
        ...
        class="filter-item"
        style="width: 200px"
        :placeholder="$t('goods_comment.placeholder.filter_user_id')"
      />
      <el-input
        ...
        class="filter-item"
        style="width: 200px"
        :placeholder="$t('goods_comment.placeholder.filter_value_id')"
      />
      <el-button
        class="filter-item"
        type="primary"
    ...
    >
      <el-table-column
        align="center"
        :label="$t('goods_comment.table.user_id')"
        prop="userId"
      />

      <el-table-column
        align="center"
        :label="$t('goods_comment.table.value_id')"
        prop="valueId"
      />

      <el-table-column
        align="center"
        :label="$t('goods_comment.table.star')"
        prop="star"
      />

      <el-table-column
        align="center"
        :label="$t('goods_comment.table.content')"
        prop="content"
      />

      <el-table-column
        align="center"
        :label="$t('goods_comment.table.pic_urls')"
        prop="picUrls"
      >
      ...
      <el-table-column
        align="center"
        :label="$t('goods_comment.table.add_time')"
        prop="addTime"
      />

      <el-table-column
        align="center"
        :label="$t('goods_comment.table.actions')"
        width="200"
    ...
    <!-- 评论回复 -->
    <el-dialog
      :visible.sync="replyFormVisible"
      :title="$t('goods_comment.dialog.reply')"
    >
      <el-form
        ref="replyForm"
        :model="replyForm"
      ...
      <div slot="footer" class="dialog-footer">
        <el-button @click="replyFormVisible = false">{{
          $t("app.button.cancel")
        }}</el-button>
