  ...
  <div class="app-container">
    ...
    <div class="filter-container">
      <el-input
        ...
        class="filter-item"
        style="width: 200px"
        :placeholder="$t('sys_notice.placeholder.filter_title')"
      />
      <el-input
        ...
        class="filter-item"
        style="width: 200px"
        :placeholder="$t('sys_notice.placeholder.filter_content')"
      />
      <el-button
        v-permission="['GET /admin/notice/list']"
        class="filter-item"
        type="primary"
        icon="el-icon-search"
        @click="handleFilter"
    ...
    >
      ...
      <el-table-column
        align="center"
        :label="$t('sys_notice.table.title')"
        prop="title"
      />

      <el-table-column
        align="center"
        :label="$t('sys_notice.table.content')"
        prop="content"
      >
        <template slot-scope="scope">
          <el-dialog
            :visible.sync="contentDialogVisible"
            :title="$t('sys_notice.dialog.content_detail')"
          >
      ...
      <el-table-column
        align="center"
        :label="$t('sys_notice.table.add_time')"
        prop="addTime"
      />

      <el-table-column
        align="center"
        :label="$t('sys_notice.table.admin_id')"
        prop="adminId"
      />

      <el-table-column
        align="center"
        :label="$t('sys_notice.table.actions')"
        min-width="100"
        class-name="small-padding fixed-width"
      >
        <template slot-scope="scope">
          <el-button
            v-permission="['POST /admin/notice/update']"
            type="primary"
            size="mini"
            @click="handleUpdate(scope.row)"
          >{{ $t("app.button.edit") }}</el-button>
          <el-button
            v-permission="['POST /admin/notice/delete']"
            type="danger"
            size="mini"
