  ...
  <div class="app-container">
    ...
    <div class="filter-container">
      <el-input
        ...
        class="filter-item"
        style="width: 200px"
        :placeholder="$t('sys_os.placeholder.filter_key')"
      />
      <el-input
        ...
        class="filter-item"
        style="width: 200px"
        :placeholder="$t('sys_os.placeholder.filter_name')"
      />
      <el-button
    ...
    >
      <el-table-column
        align="center"
        :label="$t('sys_os.table.key')"
        prop="key"
      />

      <el-table-column
        align="center"
        :label="$t('sys_os.table.name')"
        prop="name"
      />

      <el-table-column
        align="center"
        :label="$t('sys_os.table.type')"
        prop="type"
      />

      <el-table-column
        align="center"
        :label="$t('sys_os.table.size')"
        prop="size"
      />
      ...
      <el-table-column
        align="center"
        :label="$t('sys_os.table.url_link')"
        prop="url"
      />

      <el-table-column
        align="center"
        :label="$t('sys_os.table.actions')"
        width="200"
